...
export enum CustomMarket {
  ...
  */
  ...
  // v3 mainnets
  opbnb_testnet_v3 = 'opbnb_testnet_v3',
  opbnb_mainnet_v3 = 'opbnb_mainnet_v3',
...
export const marketsData: {
  ...
  // },
  //@Fifth Deployment
  [CustomMarket.opbnb_testnet_v3]: {
    v3: true,
    marketTitle: 'opBNB',
    chainId: parseInt(process.env.NEXT_PUBLIC_MANEKI_CHAINID as string) || 5611,
    enabledFeatures: {},
    addresses: {
  ...
  [CustomMarket.opbnb_mainnet_v3]: {
    v3: true,
    marketTitle: 'opBNB Testnet',
    chainId: parseInt(process.env.NEXT_PUBLIC_MANEKI_CHAINID as string) || 204,
    enabledFeatures: {},
    addresses: {
      MERKLE_DIST: process.env.NEXT_PUBLIC_MANEKI_MERKLE_DIST || '',
      LENDING_POOL_ADDRESS_PROVIDER:
